...
//            }
    ...
    override fun getAccelerometerData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
        }
    }

    override fun getRotationData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
    ...
    override fun getMagneticData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
    ...
    override fun getGyroscopeData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
    ...
    override fun getLocationData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
    ...
    override fun getWifiData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
    ...
    override fun getScreenState(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
    ...
    override fun getActivityData(oSensorEvent: SensorEvent) {
        val oAnalytics = Analytics()
        oAnalytics.analyticsData = oGson.toJson(oSensorEvent)
        oScope.async{
            oAnalyticsDao.insertAnalytics(oAnalytics)
